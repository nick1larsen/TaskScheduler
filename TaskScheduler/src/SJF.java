/**
 * This class simulates the Shortest Job First of Task scheduling. It takes in an array of process information and 
 * creates a new instance of the Process class. It then prioritizes the processes in the SJF method
 * @author Nick
 *
 */
public class SJF extends Algorithm{
	...
	/**
	 * Constructor for the SJF class
	 * @param processArray
	 */
	public SJF(int[][] processArray) {

		super(processArray);	
		System.out.println("Now executing the SJF algorithm");
	}
		...
		while(stillRunning == true) {
			...
			for(int i = 0; i < super.listOfProcess.length; i++) {
				if(super.listOfProcess[i].getArrivalTime() == super.getTime()) {
					...
					super.SJFAddToActiveProcessQ(super.listOfProcess[i].getProcessID());
